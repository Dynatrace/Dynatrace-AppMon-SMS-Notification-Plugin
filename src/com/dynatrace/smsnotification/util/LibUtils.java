package com.dynatrace.smsnotification.util;

/**
 * Utility class for detecting the operating system and architecture types, and
 * automatically loading the matching native library. <br />
 * <br />
 * Adapted from
 * [url=http://javablog.co.uk/2007/05/19/making-jni-cross-platform/]Javablog
 * Making JNI cross platform[/url] <br />
 * Extended with [url=http://lopica.sourceforge.net/os.html]JNLP os and arch
...
public class LibUtils {
	...
	public static enum ARCHType {
		PPC, PPC_64, SPARC_32, SPARC_64, X86, X86_64, ARM, MIPS, RISC, UNKNOWN
	};

	/**
	 * Loads the specified library. The full name of the library is created by
	 * calling {@link LibUtils#createLibName(String)} with the given argument.
	 * 
	 * @param baseName
	 ...
	 * current operating system and architecture. The resulting name will be of
	 * the form<br />
	 * baseName-OSType-ARCHType<br />
	 * where OSType and ARCHType are the <strong>lower case</strong> Strings of
	 * the respective enum constants. Example: <br />
	 * JOCL-windows-x86<br />
	 * 
	 * @param baseName
	 *            The base name of the library
	...
	public static ARCHType calculateArch() {
		...
		if (osArch.startsWith("sparc")) {
			...
			if (bits.equals("64")) {
				return ARCHType.SPARC_64;
			}
			return ARCHType.SPARC_32;
		}
